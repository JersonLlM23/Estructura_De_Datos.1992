...
private:
    ...
    ParametrosDemo obtenerParametros()
    {
        ...
        do
        {
            ...
            // Valor inicial
            if (!validarEntrada(params.inicio, "Valor inicial(n0) : ") ||
                params.inicio <= 0)
            {
            ...
            // Valor final
            if (!validarEntrada(params.fin, "Valor final(n): ") ||
            ...
            // Paso
            if (!validarEntrada(params.paso, "Constante(c): ") ||
    ...
    void guardarDatos(const ParametrosDemo &params, const std::string &nombreArchivo)
    {
        ...
        {
            double eLogN = TerminosMatematica::calcularELogN(n);
